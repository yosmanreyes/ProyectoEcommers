! function($) {
    ...
    CalendarApp.prototype.onDrop = function(eventObj, date) {
        ...
        CalendarApp.prototype.onEventClick = function(calEvent, jsEvent, view) {
            ...
            form.append("<div class='input-group'><input class='form-control' type=text value='" + calEvent.title + "' /><span class='input-group-btn'><button type='submit' class='btn btn-success waves-effect waves-light'><i class='fas fa-check'></i> Save</button></span></div>");
            $this.$modal.modal({
                backdrop: 'static'
            });
