    ...
    $.ajax({
        ...
        success: function success(response) {
            if (response.success == true) {
                ...
                tipo.forEach((item) => {
                    contador++;
                    document.getElementById(`imgI${contador}`).setAttribute('src', `${UrlImgInferior + item.Ruta}`);          
