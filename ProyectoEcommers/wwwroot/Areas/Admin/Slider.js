    ...
    $.ajax({
        ...
        success: function success(response) {
            if (response.success == true) {
                ...
                tipo.forEach((item) => {
                    contador++;
                    document.getElementById(`img${contador}`).setAttribute('src', `${item.Ruta}`)
                });
            } else {
...
function ConsultaImagenInferior() {
    $.ajax({
        type: 'POST',
        async: false,
        ...
        success: function success(response) {
            if (response.success == true) {
                ...
                tipo.forEach((item) => {
                    contador++;
                    document.getElementById(`imgI${contador}`).setAttribute('src', `${item.Ruta}`)
