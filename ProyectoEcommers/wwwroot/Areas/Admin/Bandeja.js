    ...
    $("#tbGrilla").DataTable({
        ...
        "columns": [
            ...
            },
            {
                data: null, title: "fecha Creación", className: "celdaCenter ", render: function (row) {
                    return resultado = `<div contenteditable="true" class="dropdown dropend editable" data-id="${row.id_compra_realizada}" data-columna="fecha_CreacionS">${row.fecha_CreacionS}</div>`
                }
            },
            {
                data: null,
                ...
                render: function (row) {
                    return `<input type="date" contenteditable="true" class="dropdown dropend editable fechaInput" id="fechaEnvioPro_${row.id_compra_realizada}" data-id="${row.id_compra_realizada}" data-columna="fecha_Envio_productoS" value="${row.fecha_Envio_productoS}" />`
                }
            },
            {
            ...
            },
            {
                ...
                render: function (row) {
                    ...
                    return `<input type="date" contenteditable="true" class="dropdown dropend editable fechaInput" id="fechaLlegadaPro_${row.id_compra_realizada}" data-id="${row.id_compra_realizada}" data-columna="fecha_Llegada_productoS" value="${row.fecha_Llegada_productoS}" />`
                }
            },
            {
                data: null,
        ...
        "rowCallback": function (row, data, index) {
            ...
            if (data.status == "approved") {
                $(row).find('td:eq(3)').addClass('SemaforoVerde');

            } else {
                $(row).find('td:eq(3)').addClass('SemaforoNaranja');
            }

            if (data.precioGeneral == "" || data.precioGeneral == null) {
                $(row).find('td:eq(8)').addClass('SemaforosVerde');
            } else {
                $(row).find('td:eq(8)').addClass('SemaforosVerde');
            }

            if (data.fecha_Envio_productoS == "" || data.fecha_Envio_productoS == null || data.fecha_Envio_productoS == "01/01/0001 12:00 a. m.") {
                $(row).find('td:eq(10)').addClass('SemaforoNaranja');
            } else {
                $(row).find('td:eq(10)').addClass('SemaforoVerde');
            }
            ...
            if (data.enviado_Satisfactoriamente == "" || data.enviado_Satisfactoriamente == null) {
                ...
                $(row).find('td:eq(12)').addClass('SemaforoAzul');
            ...
            if (data.estado_producto == null) {
                ...
                $(row).find('td:eq(14)').addClass('SemaforoAzul');
            }
            else {
                $(row).find('td:eq(14)').addClass('SemaforoVerde');
            }
            if (data.cancelada == "NO") {
                $(row).find('td:eq(27)').addClass('SemaforoVerde');
            } else {
    ...
    $("#tbGrilla2").DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                className: "celdaCenter White_Space",
                render: function (row) {
                    return `<input type="date" contenteditable="true" class="dropdown dropend editable fechaInput2"  id="fechaEnvioPro2_${row.id_compra_realizada}" data-id="${row.id_compra_realizada}" data-columna="fecha_Envio_productoS" value="${row.fecha_Envio_productoS}" />`
                }
            },
            {
            ...
            },
            {
                ...
                className: "celdaCenter White_Space",
                render: function (row) {
                    return `<input type="date" contenteditable="true" class="dropdown dropend editable fechaInput2" id="fechaLlegadaPro2_${row.id_compra_realizada}" data-id="${row.id_compra_realizada}" data-columna="fecha_Llegada_productoS" value="${row.fecha_Llegada_productoS}" />`
                }
            },
            {
                data: null,
        ...
        "rowCallback": function (row, data, index) {
            ...
            if (data.precioGeneral == "" || data.precioGeneral == null) {
                $(row).find('td:eq(8)').addClass('SemaforosAzul');
            } else {
                $(row).find('td:eq(8)').addClass('SemaforosAzul');
            }
