(function ($, moment) {
    ...
    function Plugin(element, options) {
        ...
        this.params = { date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'en', weekStart: 0, disabledDays: [], shortTime: false, clearButton: false, nowButton: false, cancelText: 'Cancelar', okText: 'Aceptar', clearText: 'Cerrar', nowText: 'Now', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year: true };
    ...
    Plugin.prototype =
    {
        ...
        initTemplate: function () {
            ...
            this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                ...
                '<div class="dtp-close"><a href="javascript:void(0);"><i class="">x</i></a></div>' +
                '</header>' +
                ...
                '<button class="dtp-btn-cancel btn btn-danger" style="padding: 1px 6px 1px 6px; margin: 8px">' + this.params.cancelText + '</button>' +
                '<button class="dtp-btn-ok btn btn-green" style="padding: 1px 6px 1px 6px">' + this.params.okText + '</button>' +
                '<div class="clearfix"></div>' +
                '</div>' +
                '</div>' +
                '</div>';
